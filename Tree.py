...
class AVL():
        ...
        while not wordIsAdded:
            if word > current_node.word:
                ...
                if current_node.rightChild == None:
                    current_node.rightChild = NodeBST(word)
                ...
                if current_node.leftChild == None:
                    current_node.leftChild = NodeBST(word)
    ...
    def traverse(self, node=None,list_of_nodes=[]):
        if node == None:
            node = self.root
